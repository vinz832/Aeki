...
public class Premiumtuer extends Produkt {
    ...
    public static final int HOLZEINHEITEN = 4;
    public static final int SCHRAUBEN = 5;
    public static final int GLASEINHEITEN = 5;
    public static final int TUERGRIFFE = 1;
    public static final int FARBEINHEITEN = 1;
    public static final int KARTONEINHEITEN = 5;
